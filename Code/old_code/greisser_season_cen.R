...
model_formula <- "sexual_score ~ gen_z + devo_bi_c + terr_bi_c +
                  devo_bi_c*temp_seasonality_z + devo_bi_c*terr_bi_c +
                  (1|gr(tree_tip, cov=A))"
...
model_pathway <- paste0("Results/Models/season_greisser_cen", data_type, "_", tree_number, ".rds") # # Add chick devlopment.
