...
model_formula <- "sexual_score ~ gen_z + devo_mode + territory_binary +
                  devo_mode*temp_seasonality_z + devo_mode*territory_binary +
                  (1|gr(tree_tip, cov=A))"
...
model_pathway <- paste0("Results/Models/season_greisser", data_type, "_", tree_number, ".rds") # # Add chick devlopment.
