...
model_formula <- "sexual_score ~ gen_z + migration_binary + territory_binary +
                  trophic_binary*temp_seasonality_z*devo_binary +
                  (1|gr(tree_tip, cov=A))"
...
# Centered
model_pathway <- paste0("Results/Models/kitchen_sink", data_type, "_", tree_number, ".rds")  # Changing the reference to altrical (larger group) and centering.
