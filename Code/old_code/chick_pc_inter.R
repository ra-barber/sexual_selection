...
# Changing ref group.
#model_pathway <- paste0("Results/Models/chick_pc", data_type, "_", tree_number, ".rds") 
#model_pathway <- paste0("Results/Models/chick_pc_centered", data_type, "_", tree_number, ".rds")# 
model_pathway <- paste0("Results/Models/chick_pc_inter", data_type, "_", tree_number, ".rds") 
#model_pathway <- paste0("Results/Models/chick_pc_season", data_type, "_", tree_number, ".rds") 
#model_pathway <- paste0("Results/Models/chick_pc_season_inter", data_type, "_", tree_number, ".rds") 
