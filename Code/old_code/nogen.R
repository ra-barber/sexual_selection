...
model_formula <- "sexual_score ~ migration_binary + territory_binary +
                  trophic_binary*temp_seasonality_z +
                  trophic_binary*npp_z + trophic_binary*territory_binary +
                  (1|gr(tree_tip, cov=A))"
...
# Removing gen length.
#model_pathway <- paste0("Results/Models/nogen_devo_", data_type, "_", tree_number, ".rds") # Removing generation length
model_pathway <- paste0("Results/Models/nogen_", data_type, "_", tree_number, ".rds") # Removing generation length and devo
