...
# model_formula <- "sexual_score ~ chick_z*gen_z + chick_z*migration_bi_c + terr_bi_c +
#                   trophic_level_c*temp_seasonality_z + chick_z*trophic_level_c + trophic_level_c*terr_bi_c +
...
# model_formula <- "sexual_score ~ chick_z + migration_binary + territory_binary +
#                   trophic_binary*temp_seasonality_z +
#                   trophic_binary*npp_z + trophic_binary*territory_binary +
#                   (1|gr(tree_tip, cov=A))"

model_formula <- "sexual_score ~ chick_z + migration_bi_c + terr_bi_c +
...
#model_pathway <- paste0("Results/Models/chick_pc_season_centered", data_type, "_", tree_number, ".rds")                ~~~~Done~~~~~~
#model_pathway <- paste0("Results/Models/chick_pc_everything", data_type, "_", tree_number, ".rds")            ~~~~Done~~~~~~
#model_pathway <- paste0("Results/Models/chick_pc_everything_centered", data_type, "_", tree_number, ".rds")     ~~~~Done~~~~~~
#model_pathway <- paste0("Results/Models/chick_pc_everything_but_npp", data_type, "_", tree_number, ".rds")        ~~~~Done~~~~~~

#model_pathway <- paste0("Results/Models/cpng", data_type, "_", tree_number, ".rds")                   ~~~~Done~~~~~~
model_pathway <- paste0("Results/Models/cpng_centered", data_type, "_", tree_number, ".rds")
