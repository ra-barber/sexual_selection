...
# model_formula <- "sexual_score ~ gen_z + fed_z + migration_binary + territory_binary +
#                   trophic_binary*temp_seasonality_z + 
#                   trophic_binary*npp_z + trophic_binary*territory_binary + 
#                   fed_z*temp_seasonality_z + 
#                   fed_z*npp_z + fed_z*territory_binary + 
#                   (1|gr(tree_tip, cov=A))"

model_formula <- "sexual_score ~ gen_z + devo_mode + migration_binary + territory_binary +
                  trophic_binary*temp_seasonality_z + 
                  trophic_binary*npp_z + trophic_binary*territory_binary + 
                  (1|gr(tree_tip, cov=A))"
...
# Changing ref group.
#model_pathway <- paste0("Results/Models/newref_devo_", data_type, "_", tree_number, ".rds")  # Changing the reference to altrical (larger group)
...
model_pathway <- paste0("Results/Models/greisser_", data_type, "_", tree_number, ".rds") # Using gressier devo models.
#model_pathway <- paste0("Results/Models/chick_", data_type, "_", tree_number, ".rds") # # Add chick devlopment.
...
# model_pathway <- paste0("Results/Models/inter_greisser_", data_type, "_", tree_number, ".rds") # Adding greiseer with interactions
# model_pathway <- paste0("Results/Models/inter_chick_", data_type, "_", tree_number, ".rds")  # Adding chick pc1 with interactions.
...
# model_pathway <- paste0("Results/Models/inter_wang_", data_type, "_", tree_number, ".rds") # Using normal wang with interactions.
