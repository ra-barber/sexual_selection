...
model_formula <- "sexual_score ~ gen_z + devo_mode + territory_binary +
...
model_pathway <- paste0("Results/Models/min_greisser", data_type, "_", tree_number, ".rds") # # Add chick devlopment.
