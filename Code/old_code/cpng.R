...
#model_pathway <- paste0("Results/Models/chick_pc_everything_but_npp", data_type, "_", tree_number, ".rds") 

model_pathway <- paste0("Results/Models/cpng", data_type, "_", tree_number, ".rds") 
