...
model_formula <- "sexual_score ~ migration_binary + territory_binary +
                  trophic_binary*temp_seasonality_z + chick_z*trophic_binary +
...
model_pathway <- paste0("Results/Models/chick_pc_no_gen", data_type, "_", tree_number, ".rds")      
model_pathway <- paste0("Results/Models/chick_pc_no_gen_centered", data_type, "_", tree_number, ".rds")         
