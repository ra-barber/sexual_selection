...
model_formula <- "sexual_score ~ gen_z + devo_binary + migration_binary + territory_binary +
                  ...
                  devo_binary*temp_seasonality_z + devo_binary*territory_binary +
                  (1|gr(tree_tip, cov=A))"

# model_formula <- "sexual_score ~ gen_z + devo_bi_c + migration_binary + territory_binary +
...
# model_pathway <- paste0("Results/Models/edited_", data_type, "_", tree_number, ".rds") # Using wang_edited                                              ~~~~ DONE ~~~~
# model_pathway <- paste0("Results/Models/inter_edited_", data_type, "_", tree_number, ".rds") # Using wang edited with interactions                   ~~~~ DONE ~~~~
...
# Centered
model_pathway <- paste0("Results/Models/edited_seasonal", data_type, "_", tree_number, ".rds")  # Changing the reference to altrical (larger group) and centering.
