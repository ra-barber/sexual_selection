...
migration_bi_c*temp_seasonality_z + migration_bi_c*terr_bi_c + (1|gr(tree_tip, cov=A))"
...
# Simple models.
model_pathway <- paste0("Results/Models/Migration/", data_type, "_", tree_number, ".rds") 
