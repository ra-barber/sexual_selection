...
assign_prum_clades <- function(data){
  ...
  # Add the clade info.
  data$higher_clade[data$order %in% Palaeognathae] <- "Palaeognathae"
  data$higher_clade[data$order %in% Galloanserae] <- "Galloanserae"
  data$higher_clade[data$order %in% Strisores] <- "Strisores"
  data$higher_clade[data$order %in% Columbaves] <- "Columbaves"
  data$higher_clade[data$order %in% Gruiformes] <- "Gruiformes"
  data$higher_clade[data$order %in% Aequorlitornithes] <- "Aequorlitornithes"
  data$higher_clade[data$order %in% Opisthocomiformes] <- "Opisthocomiformes"
  data$higher_clade[data$order %in% Accipitriformes] <- "Accipitriformes"
  data$higher_clade[data$order %in% Strigiformes] <- "Strigiformes"
  data$higher_clade[data$order %in% Coraciimorphae] <- "Coraciimorphae"
  data$higher_clade[data$order %in% Australaves] <- "Australaves"
