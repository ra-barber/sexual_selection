...
sex_lat_plot <- lat_data %>% 
  brms_lat_side_plot(ylabel = "Sexual selection", ylimits = c(0,1.2), 
                       ybreaks =  c(0,0.5,1.0), lab_ypos = 0.2, plot_label = "")

# Data certainty.
cert_lat_plot <- cert_lat_data %>% 
  brms_lat_side_plot(ylabel = "Data certainty", ylimits = c(1,4), 
                     ybreaks =  c(1,2,3,4), lab_ypos = 1.5, plot_label = "",
...
hi_sex_lat_plot <- hi_lat_data %>% 
  brms_lat_side_plot(ylabel = "Sexual selection", ylimits = c(0,1.8), 
                       ybreaks =  c(0,0.5,1.0, 1.5), lab_ypos = 0.3, plot_label = "",
...
# Export the plots.
save(list = ls(pattern =  "lat_plot"), file = "Plots/Presentation/presentation_lat_sideplots.Rdata")
gc()
