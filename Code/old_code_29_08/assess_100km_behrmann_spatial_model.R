...
sar_lat_side_plot <- function(ylabel = "", ylimits = c(0,1.2), ybreaks = c(0,0.5,1),
  ...
  ggplot(data_set, aes(x = abs_lat, y = layer)) +
    geom_point(aes(colour = binned_layer), size = 1, alpha = 0.9) +
...
# # Figure 2.
sex_lat_plot <- sar_lat_side_plot(stats_model = scaled_all_allbirds_model, plot_model = raw_all_allbirds_model,
...
cert_lat_plot <- sar_lat_side_plot(ylabel = "Data certainty", ylimits = c(1,4),
                   ...
                   plot_model = raw_all_certainty_model, stats_model = scaled_all_certainty_model)

# Primary and secondary consumers.
pri_lat_plot <- sar_lat_side_plot(ylabel = "Sexual selection", ylimits = c(-0.1,2),
                     ybreaks =  c(0,1.0, 2.0), lab_ypos = 2,
                     plot_label = "b", plot_model = raw_all_primary_model, stats_model = scaled_all_primary_model)

sec_lat_plot <- sar_lat_side_plot(ylabel = "Sexual selection", ylimits = c(-0.1,2),
                     ybreaks =  c(0,1.0,2.0), lab_ypos = 2,
                     plot_label = "f", plot_model = raw_all_secondary_model, 
...
med_sex_lat_plot <- sar_lat_side_plot(ylabel = "Sexual selection", ylimits = c(0,1.3),
                     ...
                     plot_model = raw_high_allbirds_model, stats_model = scaled_high_allbirds_model)
...
no_terr_lat_plot <- sar_lat_side_plot(ylabel = "Sexual selection", ylimits = c(0,1.6),
                     ...
                     plot_model = raw_all_noterr_model, stats_model = scaled_all_noterr_model)
...
pri_terr_lat_plot <- sar_lat_side_plot(ylabel = "Proportion of species", ylimits = c(0,1),
                     ...
                     plot_model = raw_all_primterr_model, stats_model = scaled_all_primterr_model)
# Primary year terr.
pri_yearterr_lat_plot <-  sar_lat_side_plot(ylabel = "Proportion of species", ylimits = c(0,1),
                     ...
                     plot_model = raw_all_primyearterr_model, p_year_terr = TRUE, stats_model = scaled_all_primyearterr_model)
...
sec_terr_lat_plot <- sar_lat_side_plot(ylabel = "Proportion of species", ylimits = c(0,1),
                     ...
                     plot_model = raw_all_secterr_model, stats_model = scaled_all_secterr_model)
...
sec_yearterr_lat_plot <-  sar_lat_side_plot(ylabel = "Proportion of species", ylimits = c(0,1),
                     ...
                     plot_model = raw_all_secyearterr_model, stats_model = scaled_all_secyearterr_model)



# # Export the plots.
save(list = ls(pattern =  "lat_plot"), file = "Plots/Maps/behr_100_latitudinal_sideplots.Rdata")
gc()
